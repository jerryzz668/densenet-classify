...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(8, 16, 32, 16),
                 num_init_features=64, bn_size=2, drop_rate=0.15, num_classes = 2,
...
def densenet121(num_class, pretrained = False, filter_size = 1, pool_only = True, **kwargs):
    r"""Densenet-121 model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DenseNet(num_init_features=64, growth_rate=24, block_config=(3, 4, 8, 6), num_classes = num_class,
...
def densenet169(num_class, pretrained=False, filter_size=1, pool_only=True, **kwargs):
    r"""Densenet-169 model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DenseNet(num_init_features=64, growth_rate=32, block_config=(6, 12, 32, 32), num_classes = num_class,
                    filter_size=filter_size, pool_only=pool_only, **kwargs)
    if pretrained:
...
def densenet201(num_class, pretrained=False, filter_size=1, pool_only=True, **kwargs):
    r"""Densenet-201 model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DenseNet(num_init_features=64, growth_rate=32, block_config=(6, 12, 48, 32),num_classes = num_class,
                    filter_size=filter_size, pool_only=pool_only, **kwargs)
    if pretrained:
...
def densenet161(num_class, pretrained=False, filter_size=1, pool_only=True, **kwargs):
    r"""Densenet-161 model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = DenseNet(num_init_features=96, growth_rate=48, block_config=(6, 12, 36, 24), num_classes = num_class,
                    filter_size=filter_size, pool_only=pool_only, **kwargs)
    if pretrained:
